...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {//若用户没有授权请求写入外部存储的权限，重新获取授权
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        super.onRequestPermissionsResult(requestCode, permissions, grantResults);//获取请求结果
    ...
    private void init() {
        ...
        serviceConnection = new ServiceConnection() {
            ...
            @Override
            public void onServiceDisconnected(ComponentName name) {//服务没有连接
    ...
    private void initData() {
        ...
        data1.setId("2052403824");
        data1.setArtist("胡彦斌/伯远");
        data1.setPicUrl("https://p1.music.126.net/gZK_qHus_IaAhW1Iabq-5A==/109951168652528228.jpg?param=130y130");
        data1.setName("往事随风 (Live版)");
        songs.add(data1);
        MusicData data2 = new MusicData();
        data2.setId("1934251776");
        data2.setArtist("LBI利比");
        data2.setPicUrl("https://p2.music.126.net/wYuFxK1i_5jqs58xXQ-Jfg==/109951167350445378.jpg?param=130y130");
        data2.setName("小城夏天");
        songs.add(data2);
    }
